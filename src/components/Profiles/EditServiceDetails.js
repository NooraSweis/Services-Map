...
function EditServiceDetails(props) {
    ...
    const changeHandler = (event) => {
        if (event.target.files[0]) {
            ...
            setFileName("" + props.userID + props.numberOfServices + event.target.files[0].name);
    ...
    return (
        <center className='fieldsChange' >
            ...
            <form>
                ...
                <input type="file" id="img2" name="img2" accept="image/*" onChange={changeHandler} readOnly={read} />
                ...
                <input type='text' id='editSDesc' name='editSDesc' defaultValue={description} onChange={changeDesc} readOnly={read} />
                <br />
                ...
                <input type='text' id='editSAddress' name='editSAddress' defaultValue={address} onChange={changeAddress} readOnly={read} />
                <br />
                <label htmlFor='editSStatus'>Status :</label>
                <input type='text' id='editSStatus' name='editSStatus' defaultValue={status} onChange={changeStatus} readOnly={read} />
                <br />
